...
local plug_map = {
	...
	["i|<return>"] = map_cmd([[compe#confirm({ 'keys': "\<Plug>delimitMateCR", 'mode': '' })]])
		:with_noremap()
		:with_expr()
		:with_nowait(),
	...
	-- person keymap
	["n|mf"] = map_cr("<cmd>lua require('internal.fsevent').file_event()"):with_silent():with_nowait():with_noremap(),
	...
	["n|<C-h>"] = map_cmd("<cmd>lua vim.lsp.buf_request(0, [[$ccls/navigate]], {direction = U})<CR>")
		:with_noremap()
		:with_silent(),
