...
local plug_map = {
  ...
  ["n|<leader>pu"] = map_cr("PackerUpdate")
    ...
    :with_noremap()
    :with_nowait(),
  ["n|<leader>pi"] = map_cr("PackerInstall")
    :with_silent()
    :with_noremap()
    :with_nowait(),
  ["n|<leader>pc"] = map_cr("PackerCompile")
    :with_silent()
    :with_noremap()
    :with_nowait(),
  ...
  ["n|<leader>lR"] = map_cr("LspRestart")
    ...
    :with_silent()
    :with_nowait(),
  ["n|<leader>l="] = map_cmd("<cmd>lua vim.lsp.buf.formatting_seq_sync()<CR>")
    :with_noremap()
    :with_silent()
    :with_nowait(),
  ["n|<C-f>"] = map_cmd(
  ...
  ["n|gr"] = map_cmd("<cmd>lua vim.lsp.buf.references()<CR>")
    :with_noremap()
    :with_silent(),
  ["n|gt"] = map_cmd("<cmd>lua vim.lsp.buf.type_definition()<CR>")
    :with_noremap()
    :with_silent(),
  ...
  ["t|<A-d>"] = map_cu([[<C-\><C-n>:Lspsaga close_floaterm<CR>]])
    :with_noremap()
    :with_silent(),
  ["n|<Leader>g"] = map_cu("Lspsaga open_floaterm lazygit")
    :with_noremap()
    :with_silent(),
  -- Far.vim
  ...
  ["n|<Leader>fb"] = map_cu("Telescope file_browser")
    :with_noremap()
    :with_silent(),
  ...
  ["n|<Leader>fd"] = map_cu(
    "Telescope dotfiles path=" .. os.getenv "HOME" .. "/.dotfiles"
