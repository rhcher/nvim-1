...
function fs:render_window()
  ...
  self.hcb, self.hcw, _, self.hbw = window.create_float_window(
    header_opts,
    border_opts,
    opts
  )
  ...
  self.input_cb, self.input_cw, _, self.input_bw = window.create_float_window(
    input_content_opts,
    input_border_opts,
    input_opts
  )
